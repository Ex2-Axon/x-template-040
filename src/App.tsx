...
function CounterNum({ value }: { value: number }) {
  ...
  return (
    <span ref={ref} style={{ display: 'inline-block', transition: 'all 0.3s', margin: '0 5px' }}>
      {value}
    </span>
  )
}
  ...
  return (
    <>
      <header className="hero">
        <div className="badge">SWISS-GEN V1.0</div>
        <h1>ABSOLUTE PRECISION</h1>
        <p className="subtitle">Experience the nexus of meticulous design and digital luxury, where every pixel is a testament to structured elegance and vibrant innovation.</p>
        
        <button className="btn" onClick={() => setCount((c) => c + 1)}>
          ACTIVATE PROTOCOL <CounterNum value={count} />
        </button>
      ...
      <main className="app-container">
        <div className="cards-container">
          <div className="card">
            <div className="circle small top-left"><span></span><span></span><span></span><span></span></div>
            <div className="circle"><span></span><span></span><span></span><span></span></div>
            <div className="circle small bottom-right"><span></span><span></span><span></span><span></span></div>
          </div>
          <div className="card">
            <div className="circle small top-left"><span></span><span></span><span></span><span></span></div>
            <div className="circle"><span></span><span></span><span></span><span></span></div>
        ...
        <section className="info-box half">
          <h2>Core Systems</h2>
          <p className="subtitle">Built on the foundation of Vite and React.</p>
          <ul className="social-links">
            <li><a href="https://vite.dev/" target="_blank" rel="noreferrer">Vite Docs</a></li>
